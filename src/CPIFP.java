...
public class CPIFP {
    ...
    @objid ("a727d9d4-0b26-4477-85e7-2b545e13c4e5")
    public CPIFP(final String nombre, final String direccion, final String telefono) {
        this.nombre = nombre;
    ...
    public String toString(){
        return String.format("Nombre del centro: %s\nDireccion: %s\nTeléfono: %s\n", this.nombre, this.direccion,this.telefono);
    }
